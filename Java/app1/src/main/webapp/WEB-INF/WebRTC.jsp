...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link type="text/css" href="https://lprod.code-api-att.com/public_files/css/bootstrap.min.css" rel="stylesheet">
    <!-- we are using bootstrap for our layout -->
    ...
    <script src="https://lprod.code-api-att.com/public_files/js/ewebrtc-sdk.min.js"></script>
            ...
            <div id="oauthCollapse" class="panel-collapse collapse in">
              <div class="panel-body">
                ...
                <div class="tab-content">
                  <div class="tab-pane" id="mobile" hidden>
                    <div class="row">
                      <div class="col-lg-12">
...
phone.resume();
    ...
    <!-- End Crazy Egg Code -->
    <div id="dhs" hidden>${cfg.dhs}</div>
    <div id="fqdn" hidden>${cfg.fqdn}</div>
    <div id="token_endpoint" hidden>${cfg.tokenEndpoint}</div>
    <div id="authorize_endpoint" hidden>${cfg.authorizeEndpoint}</div>
    <div id="associate_endpoint" hidden>${cfg.associateEndpoint}</div>
    <div id="account_domain" hidden>${cfg.accountDomain}</div>
  </body>
</html>
